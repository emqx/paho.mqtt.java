 ...
 */
public class EMQMqttV5Receiver implements MqttCallback {

  static final String className = EMQMqttV5Receiver.class.getName();
   ...
   * @param reportStream
   */
  public EMQMqttV5Receiver(String clientId, PrintStream reportStream) {
...
//  }
  ...
  public boolean validateReceipt(String sendTopic, int expectedQos, MqttMessage message) throws MqttException, InterruptedException {
	  return validateReceipt(sendTopic, expectedQos, message, 300);
  }
